...
\label{_controller__interface__board_md__controller___interface___board}%
\Hypertarget{_controller__interface__board_md__controller___interface___board}%
...
\begin{center} \end{center} \hypertarget{_controller__interface__board_autotoc_md3}{}\doxysubsubsubsection{\texorpdfstring{Key Features}{Key Features}}\label{_controller__interface__board_autotoc_md3}
...
Future, production version of this board may remove these additional features.\hypertarget{_controller__interface__board_autotoc_md4}{}\doxysubsubsubsection{\texorpdfstring{Board Pinout}{Board Pinout}}\label{_controller__interface__board_autotoc_md4}
\hypertarget{_controller__interface__board_autotoc_md5}{}\doxysubsubsubsection{\texorpdfstring{Circuit Diagram}{Circuit Diagram}}\label{_controller__interface__board_autotoc_md5}
...
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md6}{}\doxysubsubsubsubsection{\texorpdfstring{CTP Reset Circuit}{CTP Reset Circuit}}\label{_controller__interface__board_autotoc_md6}
...
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md7}{}\doxysubsubsubsubsection{\texorpdfstring{Element Interlock Circuit}{Element Interlock Circuit}}\label{_controller__interface__board_autotoc_md7}
...
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md8}{}\doxysubsubsubsection{\texorpdfstring{Circuit Board Layout}{Circuit Board Layout}}\label{_controller__interface__board_autotoc_md8}
The circuit board layout is provided here for completeness. For additional information, place refer to the \href{https://github.com/DVititoe/Solo_Controller/tree/main/Kicad/Controller_Board}{\texttt{ Ki\+Cad model}}.\hypertarget{_controller__interface__board_autotoc_md9}{}\doxysubsubsubsubsection{\texorpdfstring{Front of PCB}{Front of PCB}}\label{_controller__interface__board_autotoc_md9}
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md10}{}\doxysubsubsubsubsection{\texorpdfstring{Back of PCB}{Back of PCB}}\label{_controller__interface__board_autotoc_md10}
