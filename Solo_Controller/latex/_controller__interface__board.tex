\doxysection{Controller Interface Board}
...
\begin{center} \end{center} \hypertarget{_controller__interface__board_autotoc_md3}{}\doxysubsection{\texorpdfstring{Key Features}{Key Features}}\label{_controller__interface__board_autotoc_md3}
...
Future, production version of this board may remove these additional features.\hypertarget{_controller__interface__board_autotoc_md4}{}\doxysubsection{\texorpdfstring{Board Pinout}{Board Pinout}}\label{_controller__interface__board_autotoc_md4}
\hypertarget{_controller__interface__board_autotoc_md5}{}\doxysubsection{\texorpdfstring{Circuit Diagram}{Circuit Diagram}}\label{_controller__interface__board_autotoc_md5}
...
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md6}{}\doxysubsubsection{\texorpdfstring{CTP Reset Circuit}{CTP Reset Circuit}}\label{_controller__interface__board_autotoc_md6}
...
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md7}{}\doxysubsubsection{\texorpdfstring{Element Interlock Circuit}{Element Interlock Circuit}}\label{_controller__interface__board_autotoc_md7}
...
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md8}{}\doxysubsection{\texorpdfstring{Circuit Board Layout}{Circuit Board Layout}}\label{_controller__interface__board_autotoc_md8}
The circuit board layout is provided here for completeness. For additional information, place refer to the \href{https://github.com/DVititoe/Solo_Controller/tree/main/Kicad/Controller_Board}{\texttt{ Ki\+Cad model}}.\hypertarget{_controller__interface__board_autotoc_md9}{}\doxysubsubsection{\texorpdfstring{Front of PCB}{Front of PCB}}\label{_controller__interface__board_autotoc_md9}
\begin{center}\end{center} \hypertarget{_controller__interface__board_autotoc_md10}{}\doxysubsubsection{\texorpdfstring{Back of PCB}{Back of PCB}}\label{_controller__interface__board_autotoc_md10}
