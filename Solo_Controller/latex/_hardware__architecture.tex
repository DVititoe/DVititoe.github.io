...
\end{DoxyItemize}\hypertarget{_hardware__architecture_autotoc_md30}{}\doxysubsection{\texorpdfstring{Big Picture}{Big Picture}}\label{_hardware__architecture_autotoc_md30}
\hypertarget{_hardware__architecture_autotoc_md31}{}\doxysubsubsection{\texorpdfstring{Controller Layout}{Controller Layout}}\label{_hardware__architecture_autotoc_md31}
...
\begin{center}\end{center} \hypertarget{_hardware__architecture_autotoc_md33}{}\doxysubsubsection{\texorpdfstring{High Voltage Sensor Breakout Box}{High Voltage Sensor Breakout Box}}\label{_hardware__architecture_autotoc_md33}
Discuss features of the Controller Circuit.
