\doxysubsection{Control Electronics Design}
\hypertarget{_electronics__design}{}\label{_electronics__design}\index{Control Electronics Design@{Control Electronics Design}}
\label{_electronics__design_md__electronics___design}%
\Hypertarget{_electronics__design_md__electronics___design}%


Related sub-\/page\+: \doxylink{Controller_Interface_Board}{Controller Interface Board}\hypertarget{_electronics__design_autotoc_md17}{}\doxysubsubsection{\texorpdfstring{Electronics Overview}{Electronics Overview}}\label{_electronics__design_autotoc_md17}
...
Further documentation on the ER-\/\+AS-\/\+RA8875 can be found \href{https://dvititoe.github.io/Solo_Controller/html/docs/ER-AS-RA8875_Datasheet.pdf}{\texttt{ here}} and \href{https://dvititoe.github.io/Solo_Controller/html/docs/ER-TFT070A2-6-5633_Datasheet.pdf}{\texttt{ here}}.\hypertarget{_electronics__design_autotoc_md22}{}\doxysubsubsubsection{\texorpdfstring{Solo Controller Interface Board}{Solo Controller Interface Board}}\label{_electronics__design_autotoc_md22}
...
Detailed information can be found on the \href{https://dvititoe.github.io/Solo_Controller/html/_controller__interface__board.html}{\texttt{ Controller Interlace Board}} page.\hypertarget{_electronics__design_autotoc_md23}{}\doxysubsubsection{\texorpdfstring{Physical Layout of Electronics}{Physical Layout of Electronics}}\label{_electronics__design_autotoc_md23}
The following pictures show the physical layout of the electronics components\+: \begin{center}\end{center} \hypertarget{_electronics__design_autotoc_md24}{}\doxysubsubsection{\texorpdfstring{Design Considerations}{Design Considerations}}\label{_electronics__design_autotoc_md24}
...
Instead, we use one of the following two methods to display imagery on the TFT\hypertarget{_electronics__design_autotoc_md25}{}\doxysubsubsubsection{\texorpdfstring{Where the data is stored and how used}{Where the data is stored and how used}}\label{_electronics__design_autotoc_md25}
...
{\itshape Talk about where fonts are stored. talk about format. provide link to more information about font handling.}\hypertarget{_electronics__design_autotoc_md26}{}\doxysubsubsubsection{\texorpdfstring{Maximizing use of graphics chip}{Maximizing use of graphics chip}}\label{_electronics__design_autotoc_md26}
